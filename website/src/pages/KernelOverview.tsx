        ...
        {kernel.metadata && (
          <div className="mb-6">
            <h3 className="text-lg font-medium mb-3 text-gray-800">
              ...
              {kernel.isInductor && (
                <span
                  className="ml-2 px-2 py-1 text-xs bg-indigo-100 text-indigo-800 rounded border border-indigo-300"
                  title={kernel.inductorFrame
                    ? `Generated by torch.compile (inductor), frame ${kernel.inductorFrame}. Its Python source is inductor's generated output_code.py, not a hand-written kernel.`
                    : "Generated by torch.compile (inductor). Its Python source is inductor's generated output_code.py, not a hand-written kernel."}
                >
                  Inductor{kernel.inductorFrame && ` · frame ${kernel.inductorFrame}`}
                </span>
              )}
              {kernel.isFake && (
                <span
