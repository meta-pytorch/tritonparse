...
| Property | Value |
|----------|-------|
| **Values** | `"none"`, `"all"`, or comma-separated target stage names such as `"sass,xxx"` |
| **Default** | `"none"` |
...
| **Compatibility behavior** | Equivalent to including `sass` in `TRITONPARSE_DERIVED_ARTIFACTS` |
