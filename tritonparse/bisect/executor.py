...
- Streaming mode (run_command_streaming): for long-running commands
- Timeout support (blocking mode only)
...
class ShellExecutor:
    ...
    - run_command_streaming(): Streaming mode for long commands (e.g., builds)
    ...
    Example:
        ...
        >>> result = executor.run_command_streaming(["pip", "install", "-e", "."])
    """
    ...
    def run_command(
        ...
        Use this for short commands. For long-running commands like builds,
        use run_command_streaming() instead.
